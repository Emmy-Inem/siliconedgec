    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Learner Activity", tab: "activity" },
        ],
      },
      {
        label: "Assessments",
        ...
        children: [
          ...
          { label: "Instructor Assist", tab: "assist" },
        ],
      },
      {
        label: "People",
        ...
        children: [
          ...
          { label: "Q&A", tab: "qna" },
          { label: "Lesson Access", tab: "lesson-access" },
        ],
      },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Email Delivery", tab: "email-delivery" },
          { label: "Email Queue", tab: "email-queue" },
      ...
      },
      {
        ...
        children: [
          ...
          { label: "Affiliates", tab: "affiliates" },
        ],
      },
      {
        label: "Jobs",
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Installments", tab: "installments" },
    ...
    items: [
      {
        ...
        children: [
          ...
          { label: "Login Security", tab: "login-security" },
          { label: "Sessions", tab: "sessions" },
          { label: "Activity Log", tab: "activity-log" },
          { label: "SEO", tab: "seo" },
          { label: "Custom Scripts", tab: "custom-scripts" },
          { label: "Backups", tab: "backups" },
          { label: "Webhooks", tab: "webhooks" },
          { label: "Blocked IPs", tab: "blocked-ips" },
          { label: "GDPR Tools", tab: "gdpr" },
