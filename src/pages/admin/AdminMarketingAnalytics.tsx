    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
        {[
          ...
          { label: "Webinar Regs", value: webinarRegs, icon: Megaphone, accent: "text-purple-600 dark:text-purple-400", hint: "Subset of Leads" },
                ...
                <tbody>
                  {tableData.length > 0 ? tableData.slice(0, 25).map((row, i) => (
                    <tr key={i} className="border-b border-border/50 hover:bg-muted/50">
                      ...
                      <td className="py-2.5 pr-4 text-right text-purple-600 dark:text-purple-400">{row.webinars}</td>
